...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |New day - cond and big bang on mouse and on key|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
